...
|-----------------|-------------|
| **[[Natural Disasters]]** (Thiên tai) | Động đất Nhật Bản 2011 → gián đoạn chuỗi cung ứng ô tô toàn cầu; Lũ lụt miền Trung VN |
| **[[Pandemic]]** (Đại dịch) | COVID-19 → đóng cửa nhà máy, tắc nghẽn cảng, thiếu container |
...
- **[[Resilience]]** (Khả năng phục hồi) của chuỗi cung ứng
- Có nhà cung cấp dự phòng (backup suppliers) hay không
- **[[Safety Stock]]** (Tồn kho an toàn) có đủ để "cầm cự" trong thời gian gián đoạn không
- **[[Flexibility]]** (Tính linh hoạt) trong chuyển đổi nguồn cung
...
2. **[[Internal Integration]]** (Tích hợp nội bộ): Các bộ phận trong cùng một công ty (mua hàng, sản xuất, logistics, bán hàng) phối hợp chặt chẽ.
   - Dùng hệ thống [[ERP]] (Enterprise Resource Planning) như SAP, Oracle
   - Dùng quy trình [[S&OP]] ([[Sales and Operations Planning]])

3. **[[External Integration]]** (Tích hợp bên ngoài): Phối hợp với nhà cung cấp và khách hàng bên ngoài.
   - Chia sẻ **[[POS Data]]** (dữ liệu bán hàng) với nhà cung cấp
...
- **Toyota và nhà cung cấp**: Toyota chia sẻ kế hoạch sản xuất với nhà cung cấp cấp 1 và cấp 2, hỗ trợ kỹ thuật để nâng cao năng lực → quan hệ **[[Strategic Partnership]]** (đối tác chiến lược).
...
1. **[[Demand Forecast Updating]]** (Dự báo nhu cầu): Mỗi mắt xích tự dự báo dựa trên đơn hàng nhận được (không phải nhu cầu thực), thêm tồn kho an toàn → khuếch đại biến động.
   - *Ví dụ*: Khách mua 100 SP → Cửa hàng đặt 120 (thêm 20 phòng ngừa) → Phân phối đặt 150 → Nhà máy sản xuất 200.

2. **[[Order Batching]]** (Đặt hàng theo lô): Thay vì đặt hàng liên tục, mỗi mắt xích gom đơn hàng theo lô (batch) để tiết kiệm chi phí vận chuyển và đặt hàng → tạo ra mô hình nhu cầu "nhảy cóc".
   - *Ví dụ*: Thay vì đặt 10 SP mỗi ngày, đặt 70 SP mỗi tuần một lần.

3. **[[Price Fluctuations]]** (Biến động giá): Khi có khuyến mãi, khách hàng mua tích trữ (forward buying), tạo ra nhu cầu ảo lớn. Sau khuyến mãi, nhu cầu giảm mạnh.
   - *Ví dụ*: Khuyến mãi dầu ăn giảm 30% → người tiêu dùng mua gấp 3-4 lần bình thường → tuần sau gần như không mua.

4. **[[Shortage Gaming]]** (Thiếu hụt và phân phối theo tỷ lệ): Khi sản phẩm thiếu hụt, khách hàng đặt hàng nhiều hơn cần (để đảm bảo nhận đủ khi bị cắt giảm) → tạo nhu cầu ảo.
...
## 4. **[[Supply Chain Risk Management]]** (Quản lý rủi ro chuỗi cung ứng)

### Định nghĩa (Definition)
**[[Supply Chain Risk Management]]** (Quản lý rủi ro chuỗi cung ứng - SCRM) là quá trình nhận diện, đánh giá, và giảm thiểu các rủi ro có thể gây gián đoạn hoặc tác động tiêu cực đến chuỗi cung ứng.

### 4.1 **[[Operational Risks]]** (Rủi ro vận hành)
...
### 4.2 **[[Financial Risks]]** (Rủi ro tài chính)
...
### 4.3 **[[Security Risks]]** (Rủi ro an ninh)

- **Trộm cắp hàng hóa**: Mất mát trong quá trình vận chuyển hoặc lưu kho
- **[[Cyberattack]]** (Tấn công mạng): Ransomware, đánh cắp dữ liệu khách hàng
  - *Ví dụ*: Tấn công SolarWinds 2020 ảnh hưởng hàng ngàn doanh nghiệp
- **[[Counterfeiting]]** (Hàng giả): Sản phẩm giả mạo xâm nhập chuỗi cung ứng
...
| Chiến lược | Mô tả |
|-----------|-------|
| **[[Multi-sourcing]]** (Đa dạng hóa nhà cung cấp) | Không phụ thuộc vào một nhà cung cấp duy nhất |
| **[[Safety Stock]]** (Tồn kho an toàn) | Giữ hàng dự phòng để đối phó gián đoạn |
...
| **[[Contingency Plan]]** (Kế hoạch dự phòng) | Lập kế hoạch ứng phó cho các tình huống xấu |
...
## 5. **[[Cloud Computing]]** (Điện toán đám mây) và **[[Blockchain]]** trong chuỗi cung ứng

### 5.1 **[[Cloud Computing]]** (Điện toán đám mây)
...
1. **[[Traceability]]** (Truy xuất nguồn gốc): Theo dõi sản phẩm từ nguyên liệu đến tay người tiêu dùng
...
2. **[[Smart Contracts]]** (Hợp đồng thông minh): Tự động thực hiện thanh toán khi điều kiện giao hàng được đáp ứng
...
4. **[[Supply Chain Finance]]** (Tài chính chuỗi cung ứng): Xác nhận giao dịch nhanh hơn, giảm rủi ro gian lận
...
### Định nghĩa (Definition)
Quy trình **[[New Product Development]]** (Phát triển sản phẩm mới - [[NPD]]) là chuỗi các bước biến ý tưởng thành sản phẩm/dịch vụ hoàn chỉnh sẵn sàng ra thị trường. Đây là một quy trình cốt lõi của chuỗi cung ứng vì sản phẩm mới ảnh hưởng đến toàn bộ chuỗi (nguyên liệu mới, quy trình mới, nhà cung cấp mới).
...
#### Giai đoạn 4: **[[Full Launch]]** (Ra mắt toàn diện)
- Sản xuất hàng loạt
...
### Ví dụ thực tế
- **Apple iPhone**: Mỗi iPhone mới cần thiết kế chuỗi cung ứng từ sớm — đặt hàng chip từ TSMC 2 năm trước, tìm nguồn kính Gorilla Glass từ Corning, lắp ráp tại Foxconn. **[[Concurrent Engineering]]** (Thiết kế đồng thời) giúp rút ngắn thời gian ra mắt.
...
### Định nghĩa (Definition)
**[[Supplier Relationship Management]]** (Quy trình quản lý nhà cung cấp / [[SRM]]) là chuỗi hoạt động nhằm lựa chọn, phát triển, và duy trì mối quan hệ với nhà cung cấp để tối ưu hóa giá trị cho chuỗi cung ứng.

### Các hoạt động chính

#### 7.1 **[[Sourcing]]** (Tìm nguồn cung)
...
#### 7.2 **[[Design Collaboration]]** (Hợp tác thiết kế)
...
- Các phương pháp đàm phán:
  ...
  - **[[Reverse Auction]]** (Đấu giá ngược): NCC cạnh tranh giảm giá trực tuyến
- Hợp đồng dài hạn vs Hợp đồng ngắn hạn

#### 7.4 **[[Vendor Managed Inventory]]** (Quản lý tồn kho bởi nhà cung cấp - VMI)
...
#### 8.2 **[[Supply Planning]]** (Hoạch định cung ứng)
...
#### 9.3 **[[Customer Service]]** (Dịch vụ khách hàng)
...
- **[[Integrated Supply Chain]]** (Chuỗi cung ứng tích hợp)
- **[[Bullwhip Effect]]** (Hiệu ứng Bullwhip / Hiệu ứng roi da)
- **[[SCRM]]** (Quản lý rủi ro chuỗi cung ứng)
- **[[Operational Risk]]** (Rủi ro vận hành)
- **[[Financial Risk]]** (Rủi ro tài chính)
- **[[Security Risk]]** (Rủi ro an ninh)
- **[[Cloud Computing]]** (Điện toán đám mây)
- [[Blockchain]]
- **[[Smart Contracts]]** (Hợp đồng thông minh)
- **[[NPD]]** (Phát triển sản phẩm mới)
...
- **[[Design Collaboration]]** (Hợp tác thiết kế)
